    ...
    <header className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <button className="ml-6" onClick={handleUToggle}>
            <FontAwesomeIcon icon={faUserCircle} size='lg'/>
          </button>
          {isUOpen && (
            <div className="absolute top-16 right-0 mt-2 w-48 bg-white border border-gray-200 rounded shadow-lg z-10" ref={dropdownRef}>
              {username ? (
                <div>
        ...
        {isOpen && (
          <div className="absolute top-16 right-0 mt-2 w-48 bg-white border border-gray-200 rounded shadow-lg z-10">
            <ul>
              <li>
