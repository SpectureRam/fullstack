...
public class SwaggerConfig {
    ...
    @Value("${icharge.swagger.contact.name}")
    private String name;

    @Value("${icharge.swagger.contact.email}")
    private String email;

    @Value("${icharge.swagger.contact.url}")
    private String url;
    ...
    public OpenAPI openAPI(){
        ...
        .title("iCharge")
        .description("iCharge is a mobile recharge application.")
        .version("1.0.0")
        .contact(new Contact()
                .name(name)
                .email(email)
