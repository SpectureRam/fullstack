    ...
    <div>
      <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <aside className="relative block h-0 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6 lg:block">
            <img
              alt=""
              src={BG}
          ...
          >
            <div className="max-w-xl lg:max-w-3xl w-full">
              ...
              <p className="mt-4 leading-relaxed text-gray-500">
                Your gateway to hassle-free recharging - Sign up now!
              </p>
              ...
              <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    id="Email"
                    name="email"
                    className="shadow appearance-none border rounded w-full py-2 pl-4 pr-32 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  />
                </div>
                ...
                <div className="col-span-6 sm:col-span-3">
                  <label htmlFor="LastName" className="block text-sm font-medium text-gray-700"> Phonenumber </label>
                  <input
                    type="text"
                    id="LastName"
                    name="last_name"
                ...
                <div className="col-span-6">
                  <p className="text-sm text-gray-500">
                    ...
                    <a href="#" className="text-gray-700 font-bold"> terms and conditions </a>
                    and
                    <a href="#" className="text-gray-700 font-bold"> privacy policy</a>.
                  </p>
                </div>
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  ...
                  <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                    ...
                    <a href="#" className="text-gray-700 font-bold"> <NavLink to={"/login"}>Log in</NavLink></a>.
                  </p>
                </div>
              </form>
            </div>
